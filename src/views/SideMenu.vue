<template>
	<div>
		<v-list dense>
			<v-list-item>
				<v-list-item-content>
					<v-list-item-title class="title">Kudu-Colossus</v-list-item-title>
					<v-list-item-subtitle>Welcome, Simong</v-list-item-subtitle>
				</v-list-item-content>
			</v-list-item>
			...
			>
				...
				<v-list-item v-for="(s,k) in value" :key="k" @click="$router.push(s.link)">
					<v-list-item-action>
			...
			<v-list-item class="mt-4" @click disabled>
				<v-list-item-action>
